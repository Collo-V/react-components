...
class ReactQuill extends React.Component<ReactQuillProps, ReactQuillState> {
    ...
    */
    isEqualValue(value: unknown, nextValue: unknown): boolean {
    ...
    */
    ...
    accessors found on the editor instance, without unknown state-modifying methods.
    */
